...
# Pre-computation histogram models
model_histograms = {}
for pid in product_ids:
    ...
    if img_model_color is not None:
        ...
        print(f"[ATTENTION] Impossible load color model per histogram: {path}")
...
for scene_name in scene_names:
    ...
    for pid in product_ids:
        ...
        if bbox is None or info["inliers"] < MIN_INLIERS:
            print("    -> REJECTED (Too few inliers or bbox NONE)")
            continue
