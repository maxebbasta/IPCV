...
if __name__ == "__main__":
    ...
    for scene_name in scene_names:
        ...
        # tengo quello con colore più coerente col modello
        # --------------------------------------------------------
        final_detections = []
        ...
        for det in detections:
            ...
            for kept in final_detections:
                if iou(bbox, kept["bbox"]) > IOU_THRESHOLD:
                    # conflitto: stessa scatola o scatole molto vicine
                    if sim > kept["sim"]:
                        # questa detection è più coerente come colore -> sostituisco
